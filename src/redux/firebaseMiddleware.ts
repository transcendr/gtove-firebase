...
interface FirebaseMiddleware<T> {
    syncToClient: (setScenarioAction: object, firebaseRef: Firebase) => Promise<T>;
};

const firebaseMiddleware = <Store>({ syncToClient }: FirebaseMiddleware<Store>) => {
